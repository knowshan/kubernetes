...
func TestSync(t *testing.T) {
	...
	tests := []controllerTest{
		...
		// volumes.
		{
			...
			expectedEvents:  noevents, errors: noerrors, test: testSyncClaim,
		},
		{
		...
		},
		{
			...
			expectedEvents:  noevents, errors: noerrors, test: testSyncClaimError,
		},
		{
			// syncClaim with claim pre-bound to a PV that exists and is
		...
		},
		{
			...
			expectedEvents:  []string{"Warning VolumeMismatch"}, errors: noerrors, test: testSyncClaim,
		},
		{
			// syncClaim with claim pre-bound to a PV that exists and is
		...
		// [Unit test set 3] Syncing bound claim
		{
			...
			expectedEvents:  []string{"Warning ClaimLost"}, errors: noerrors, test: testSyncClaim,
		},
		{
		...
		},
		{
			...
			expectedEvents:  []string{"Warning ClaimMisbound"}, errors: noerrors, test: testSyncClaim,
		},
		{
		...
		// [Unit test set 4] All syncVolume tests.
		{
			...
			expectedEvents:  noevents, errors: noerrors, test: testSyncVolume,
		},
		{
